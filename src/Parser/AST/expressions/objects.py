from Compiler.VM.Codegen.expressions import objects as compile_vm
from Compiler.ASM.Codegen.expressions import objects as compile_asm
from Interpreter.Eval.expressions import objects as interpreter

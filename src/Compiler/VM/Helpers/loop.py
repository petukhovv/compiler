...
class Loop():
    ...
    """
    @staticmethod
    def simple(commands, env, callback, return_counter=False):
        return Loop.base(commands, env, None, callback, False, return_counter)
    ...
    """
    @staticmethod
    def stack(commands, env, callback, load_counter=True, return_counter=False):
        ...
        result = Loop.base(commands, env, check_break_condition, callback, load_counter, return_counter)
    ...
    """
    @staticmethod
    def data(commands, env, start_pointer, callback=None, load_counter=True, return_counter=False, memory_type='heap'):
        ...
        return Loop.base(commands, env, check_break_condition, callback, load_counter, return_counter)
    ...
    """
    @staticmethod
    def data_stack(commands, env, start_pointer, callback=None, load_counter=True, return_counter=False):
        return Loop.data(commands, env, start_pointer, callback, load_counter, return_counter, memory_type='stack')
    ...
    """
    @staticmethod
    def data_heap(commands, env, start_pointer, callback=None, load_counter=True, return_counter=False):
        return Loop.data(commands, env, start_pointer, callback, load_counter, return_counter)
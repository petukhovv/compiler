...
При попытке записи переменных и других массивов в boxed-массивы осуществляется "заворачивание" присваемого значения в специальный класс `Pointer`, которые принимает ссылку на environment, в котором находится значение, и выражение, соответствующее этому значению (простой или составной AST-класс).
